...
export function registerBetTools(server: McpServer) {
  ...
  server.tool(
    ...
    async ({
      ...
      try {
        ...
        if (currency_mode !== undefined) params.currency_mode = currency_mode;
        if (following !== undefined) params.following = following;
        if (past_bets !== undefined) params.past_bets = past_bets;
        if (question !== undefined) params.question = question;
  ...
  server.tool(
    "place_bet",
    {
      ...
      position: z
        ...
        .default("l")
        .describe(
          "Position type: 'l' for long (bet in favor) or 's' for short (bet against)"
        ),
  ...
  server.tool(
    ...
    async ({ id, shares, amount }) => {
      try {
        ...
        if (shares !== undefined) requestBody.shares = shares;
