...
export function registerMarketTools(server) {
    ...
    server.tool("get_markets", {
        ...
        try {
            ...
            if (params.categories !== undefined && params.categories.length > 0) {
                params.categories.forEach(category => queryParams.append("categories", category.toString()));
            }
            if (params.currency_mode)
                queryParams.append("currency_mode", params.currency_mode);
            if (params.hide_my_bets !== undefined)
                queryParams.append("hide_my_bets", params.hide_my_bets.toString());
            if (params.limit !== undefined)
                queryParams.append("limit", params.limit.toString());
            if (params.live !== undefined)
                queryParams.append("live", params.live.toString());
            if (params.offset !== undefined)
                queryParams.append("offset", params.offset.toString());
            if (params.only_markets_i_follow !== undefined)
                queryParams.append("only_markets_i_follow", params.only_markets_i_follow.toString());
            if (params.ordering)
                queryParams.append("ordering", params.ordering);
            if (params.resolved_only !== undefined)
                queryParams.append("resolved_only", params.resolved_only.toString());
            if (params.search)
    ...
    server.tool("get_market_details", {
